...
import { SerializedEventPaylod } from 'src/shared/domain/interfaces/serializable-event';

@EventsHandler(AlarmCreatedEvent)
export class AlarmCreatedEventHandler
  implements IEventHandler<SerializedEventPaylod<AlarmCreatedEvent>>
{
  ...
  async handle(event: SerializedEventPaylod<AlarmCreatedEvent>) {
